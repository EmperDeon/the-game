...
public class Logger implements Serializable {
 ...
 private class LogE implements LogEn, Serializable {
  ...
  public String toString () {
   switch ( type ) {
    case Warning:
     return "<p style=\" color: #ffc100 \" >[" + new SimpleDateFormat(
        "dd.MM.yyyy HH:mm:ss").format(date) + "] " + clas + " - " + info + "</p>";
    case Info:
     return "<p style=\" color: #009dff \" >[" + new SimpleDateFormat(
        "dd.MM.yyyy HH:mm:ss").format(date) + "] " + clas + " - " + info + "</p>";
    default:
     return "<p style=\" color: #9f9f9f \" >[" + new SimpleDateFormat(
        "dd.MM.yyyy HH:mm:ss").format(date) + "] " + clas + " - " + info + "</p>";
   }
  }
 ...
 private class LogEx implements LogEn, Serializable {
  ...
  public String toString () {
   ...
   return "<p style=\" color: red \" >[" + new SimpleDateFormat(
      "dd.MM.yyyy HH:mm:ss").format(date) + "] Exception in " + clas + " - " + t.
      toString() + "</p>";
  }
