 ...
 * @author ilya
 */
public class ModEditor1 extends javax.swing.JFrame {
 ...
 public class ItemsTable implements TableModel {
  ...
  private final ArrayList<IItem> items;

  public ItemsTable ( ArrayList<IItem> items ) {
   this.items = items;
  }
 ...
 public class BlocksTable implements TableModel {
  ...
  public BlocksTable ( ArrayList<IItem> items ) {
   this.items = items;
  }
 ...
 public class CraftsTable implements TableModel {
  ...
  public CraftsTable ( ArrayList<IItem> items ) {
   this.items = items;
  }
