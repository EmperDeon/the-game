...
//  }
   ...
   src.add(main.Main.mdir + "src/mods/" + modname.getText() + "/main.java");
   src.add(main.Main.mdir + "src/mods/" + modname.getText() + "/modact.java");
   src.add(main.Main.mdir + "src/mods/" + modname.getText() + "/itemact.java");
   src.add(main.Main.mdir + "src/mods/" + modname.getText() + "/blockact.java");
   
   ArrayList<String> arg = new ArrayList<>();
   arg.add("-d");
   arg.add(d.getAbsolutePath());
   arg.add("-verbose");
   arg.add("-classpath");
   ...
   arg.add(t);
   arg.add("-sourcepath");
   arg.add(main.Main.mdir+"src/");
   
   d = new File(main.Main.mdir + "tmp/" + modname.getText() + "/");
   d.mkdirs();
   ...
   JavaCompiler.CompilationTask task = compiler.getTask(new FileWriter(new File(main.Main.mdir+"lodc.txt")) , fileManager ,
                                                                                      new DiagnosticCollector<>() ,
                                                                                      arg ,
                                                                                      null , fileManager.
                                                                                              getJavaFileObjectsFromStrings(
