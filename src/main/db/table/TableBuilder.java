...
import main.db.util.PureJavaCrc32C;
...
import static main.db.impl.VersionSet.TARGET_FILE_SIZE;
...
public class TableBuilder
{
    ...
    public TableBuilder(OptionsDB options, FileChannel fileChannel, UserComparator userComparator)
    {
