...
import main.db.DB;
import main.db.DBFactory;
import main.db.OptionsDB;
import main.db.util.FileUtils;
...
public class Iq80DBFactory implements DBFactory {
    ...
    @Override
    public DB open(File path, OptionsDB options) throws IOException {
        return new DbImpl(options, path);
    }

    @Override
    public void destroy(File path, OptionsDB options) throws IOException {
        // TODO: This should really only delete leveldb-created files.
        FileUtils.deleteRecursively(path);
    }

    @Override
    public void repair(File path, OptionsDB options) throws IOException {
