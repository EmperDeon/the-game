...
public final class Options implements Serializable {
 ...
 public String get ( String key ) {
  if ( this.opt.containsKey(key) ) {
   ...
   main.Main.LOG.addE("Options.get()" , new Exception(
                      "Error with getting value with key " + key));
   return null;
  }
 }
 ...
 public void load () {
  try ( ObjectOutputStream serial = new ObjectOutputStream(new FileOutputStream(
          file)) ) {
