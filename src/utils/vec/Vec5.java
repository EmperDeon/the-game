...
public class Vec5 <T>{
 ...
 public void sDx(T dx){ this.dx = dx; }
 public void sDy(T dy){ this.dy = dy; }
 
 public T gX(){ return this.x; }
 public T gY(){ return this.y; }
 public T gZ(){ return this.z; }
 public T gDx(){ return this.dx; }
 public T gDy(){ return this.dy; }
}
