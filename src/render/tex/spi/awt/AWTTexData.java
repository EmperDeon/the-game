...
public class AWTTexData extends TexData {
     ...
     * TexData "wraps" the contents of the BufferedImage, so if a
     * modification is made to the BufferedImage between the time the
     * TexData is constructed and when a Tex is made from the
     * TexData, that modification will be visible in the resulting
     * Tex.
     *
     ...
     */
    public AWTTexData(GLProfile glp,
                          int internalFormat,
                          int pixelFormat,
                          boolean mipmap,
                          BufferedImage image) {
