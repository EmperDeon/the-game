 ...
 * the notion of a Tex to support things like streaming in of
...
public class TexData implements Serializable{
    ...
    // These booleans are a concession to the AWTTexData subclass
     ...
     * resources associated with this TexData when processing is
    ...
    protected TexData(GLProfile glp) { this.glProfile = glp; this.pixelAttributes = GLPixelAttributes.UNDEF; }
    ...
    /** Indicates to this TexData whether the GL_EXT_abgr extension
    ...
    /** Indicates to this TexData whether OpenGL version 1.2 is
    ...
    /** Returns an estimate of the amount of memory in bytes this
        TexData will consume once uploaded to the graphics card. It
    ...
    /** Flushes resources associated with this TexData by calling
        Flusher.flush(). */
    public void flush() {
        if (flusher != null) {
            flusher.flush();
    ...
    /** Defines a callback mechanism to allow the user to explicitly
        ...
        associated with a particular TexData. */
    ...
    public String toString() {
        return "TexData["+width+"x"+height+", y-flip "+mustFlipVertically+", internFormat 0x"+Integer.toHexString(internalFormat)+", "+
