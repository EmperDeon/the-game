...
public static final Tile bush = new Bush(6);
  ...
  {
  if (!level.isSolidTile(x, y, z)) if ((level.isLit(x, y, z) ^ layer == 1)) return true; 
  return false;
  }
  ...
  public final Phys getTileAABB(int x, int y, int z)
  {
  return new Phys(x, y, z, x + 1, y + 1, z + 1);
  }

  public Phys getAABB(int x, int y, int z)
  {
  return new Phys(x, y, z, x + 1, y + 1, z + 1);
  }
 ...
 * Qualified Name:     minecraft.level.tile.Tile
